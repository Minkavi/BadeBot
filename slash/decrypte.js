...
module.exports = {
    ...
    async execute(interaction) {
        ...
        const options = [
            ...
            "this is hugo decypher from USA yeehaw",
            "Hugo décrypte ton pare-feu et t'envoie un cheval de troie de 3 teraoctets",
            "C'est en réalité plutôt simple de pirater sa 3DS aujourd'hui",
            "Ici Hugo et aujourd'hui on va décripter de l'ammoniac et de la javel",
            "J'ai volé le poissongue du chiengue",
            "Je suis le Hugo du futur il faut absolument voter Marine Le Pen aux prochaines élections",
            "Je suis le Hugo du passé il faut absolument voter Arnaud Montebourg aux prochaines élections",
            "Je suis le Hugo du présent fermez la en fait stp je décrypte pas",
            "saluent saient ugoent",
            "nik la cpe",
            "Je déteste !",
            ...
            "squeezie gaming",
            "3,5 skouizi²",
            "lol j'ai vu usul dans le train aujourd'hui, je lui ai proposé de discuter mais manifestement j'étais pas assez important pour mériter son attention donc je le dis ici : usul t'es complètement devenu nul à chier et t'as régressé intellectuellement comme politiquement",
            "Aujourd’hui c’est dimanche comme chaque dimanche",
            "BONJOUR LES CAMEROUNAIS",
            "J'ai 18 ans et je n’ai pas d'amis. Je decrypte 12h par jour tous les jours. Je ne fais pas de soirée, je ne bois pas, je  ne joue pas aux jeux vidéo, je ne vais pas en boite… Mais je vis ma meilleure vie. Peu de gens comprendront...",
            "Ce décryptage c'est pour me tuer ou quoi la team ?",
            "le tournepluie de parasol",
            "pourquoi être terroriste quand on peut être Hugo Décrypte",
            "chuis la jdécrypte",
            "Squeezie Lénine",
            "Le streamer français 'Sardoche' a donné 10% de l'argent qu'il gagnait a une oeuvre de charité durant 16 ans et 10 mois de sa vie. Cherchez 'Sardoche 16 ans et 10 mois' sur Google pour en apprendre plus",
            "Aucun touite de maddy est original",
            "Salut c'est Hugo, aujourd'hui on va analyser les allégations d'implication de la CIA dans le trafic de drogue aux États-Unis dans les années 80",
            "ils je heu ils sont en train de heu me ping sur discord",
            "J'aime les couleurs",
            "Hugo heu... heu... mm... dé-heu...",
            "oue ses greg",
            "TU VIENS AVEC MOI",
            "Comme dirait cyprien Je déteste ! Le mariage homosexuel",
            "Hugo の解読: フェーズ 2 - OVERDRIVE",
            "Oppenheimer Style",
            "Pruah pétable",
            "C'est barbecue party",
            "le CONSEIL, SCIENTIFIQUE",
            "il faut une discussion entre the good doctor et bigard",
            "les 15 kilos de C-4 planqués sous ta voiture prêts a exploser ce jeudi 22 novembre à 14h24 : ",
            "et pendant que vous vous êtes là à râler sur vos claviers, moi j'ai touché l'chèque. ah. ah ouais. donc au final, qui est le plus con dans l'histoire",
            "rien compris",
            "Attention : votre compte Hugo&Moi est arrivé à expiration. Pour le renouveler, veuillez donner votre numéro de carte bleue, la date d'expiration et les trois numéros au dos. Bon décryptage !",
            "https://deouf.penis.community/",
            "ZIZI",
            "Quand je finis avec mon escorte, je suis en sueur ! Mais ca valait le coup, elle est crevée la petite 🥵 Espérons pour vous que c'était pas votre daronne. On sait jamais",
            "Tournée de Ora Ora !!! 😂😂😂 Comment ça mon jotaro sucrée au sucre ??? Yare yare dazee..... Ahahah yare da listenbourg daze 😂😂 ☠️☠️",
            "révélations médiapart : voici ton numéro de carte bleue, les trois chiffres au dos et la date d'expiration",
